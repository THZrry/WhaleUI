...
static const char* kHtml =
    ...
    "</select>"
    "</div>"
    "<p class=\"muted\">涓嬫媺閫夋嫨涓婚� 路 T 娣辨祬鑹?路 +/- 鏂囧瓧缂╂斁 路 ESC 閫€鍑?/p>"

    "<div class=\"row\">"
    "<div class=\"card anim-card\">"
    "<h2 class=\"anim-rise\">Animations</h2>"
    "<p class=\"anim-rise d1\">@keyframes rise 路 cubic-bezier + fill both(閿欏嘲)</p>"
    ...
    "<span class=\"muted\" style=\"font-size:12px\">pulse 路 scale + opacity infinite</span>"
    "</div>"
    ...
    "</div>"
    "<p class=\"muted\" style=\"font-size:12px\">bar 路 width 寰€杩?alternate);"
    "hover 鏈�崱鐗囦笂娴?transition transform)</p>"
    "</div>"
    "</div>"
    ...
    "<div class=\"card\">"
    "<h2>Controls</h2>"
    "<p style=\"margin-bottom:10px\"><strong>flex</strong> + 鍦嗚�杈规�(璺熼殢寮х嚎)</p>"
    ...
    "<div class=\"card\">"
    "<h2>Theme vars</h2>"
    "<p>--card / --border / --muted / --accent 闅忎富棰樹笌娣辨祬鑹插垏鎹?"
    "瀵规湭鑷�畾涔夋牱寮忕殑鏍囩�鍚屾牱鐢熸晥銆?/p>"
    "<p class=\"theme-note\">娣辫壊涓婚�涓嬫�鏂囧瓧鍙樹寒钃?@media prefers-color-scheme)銆?/p>"
    "</div>"
    "<div class=\"card\">"
    "<h2>Overflow</h2>"
    "<div class=\"clip-box\">long text clipped by overflow hidden</div>"
    "<p class=\"muted\" style=\"margin-top:10px;opacity:0.6\">opacity 0.6 娆¤�鏂囧瓧</p>"
    "</div>"
    "</div>"
    "</div></body></html>";
